$FunctionName =  "Get-RIDGroupStaticMember"
Describe 'Get-RIDGroupStaticMember' -Tag 'Get-RIDGroupStaticMember','RIDGroupStaticMember' {
    BeforeAll {
    ...
    Context 'Parameter & Help  Checks' {
		...
		BeforeAll {
			$helpinfo = Get-Help Get-RIDGroupStaticMember
		}

		It 'should have Identity as mandatory' {
			{Get-RIDGroupStaticMember -Identity $null} | Should -Throw
		}
		It 'should have Help' {
    ...
    Context 'function checks' {
        ...
        It 'should call Get-ADGroup' {
            Get-RIDGroupStaticMember -Identity "PesterGroup"

            Should -Invoke Get-ADGroup -Times 1 -Scope It
        }
        It 'should return idautoGroupCoOwners value' {
            (Get-RIDGroupStaticMember -Identity "PesterGroup").idautoGroupStaticIncludes | Should -BeTrue
        }
